        ...
        <div class="rvt-container-lg">
            <div class="rvt-footer-base__inner">
                ...
                <ul class="rvt-footer-base__list">
                    ...
                    <li class="rvt-footer-base__item">
                        <a class="rvt-footer-base__link" href="https://protect.iu.edu/privacy/index.html">Privacy Notice</a>
                    </li>
                    <li class="rvt-footer-base__item">
                        <a class="rvt-footer-base__link" href="https://www.iu.edu/copyright/index.html">Copyright</a> &#169; 2021 The Trustees of <a
